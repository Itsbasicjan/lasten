# meinplugin- Frontend Code

This directory contains the frontend code for the meinplugin plugin.
...
This will compile the frontend into the `../meinplugin/static` directory (ready for distribution).
