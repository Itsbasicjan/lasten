...
class meinplugin(ScheduleMixin, SettingsMixin, UserInterfaceMixin, NavigationMixin, UrlsMixin, InvenTreePlugin):
    ...
    return [
        ...
        # URL für die Ausleihfunktion: /plugin/meinplugin/ausleihen/
        path('ausleihen/', self.loan_view, name='ausleihen'),
    ]

    # Eine einfache View-Funktion, die einen "Hallo Welt"-Text ausgibt
    ...
    # Die neue View-Funktion für die Ausleihe
    def loan_view(self, request, *args, **kwargs):
        ...
        if request.method == 'POST':
            ...
            # Dies ist ein Beispiel, das lediglich eine Bestätigungsmeldung anzeigt.
